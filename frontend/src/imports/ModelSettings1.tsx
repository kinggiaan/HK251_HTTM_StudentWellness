import svgPaths from "./svg-24pp62cn5v";
...
export default function ModelSettings1() {
  return (
    <div className="bg-white overflow-clip relative rounded-[30px] shadow-[0px_5.94px_23.761px_0px_rgba(12,30,51,0.12)] size-full" data-name="ModelSettings 1">
      <Welcome />
      <Header />
      <WelcomeHelp />
