  ...
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
      <g id="vuesax/bold/note-2">
        <path d={svgPaths.p2a321e00} fill="var(--fill-0, #0C1E33)" id="Vector" />
        <path d={svgPaths.p1e977b80} fill="var(--fill-0, #0C1E33)" id="Vector_2" />
        <g id="Vector_3" opacity="0"></g>
      </g>
    </svg>
  );
...
function SearchNormal() {
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
      <g id="search-normal">
        <g id="Group 1">
          <path d={svgPaths.p246ea500} fill="var(--fill-0, #495D72)" id="Vector" />
          <path d={svgPaths.p3f321470} fill="var(--fill-0, #495D72)" id="Vector_2" />
        </g>
        <g id="Vector_3" opacity="0"></g>
      </g>
    </svg>
...
function Frame15() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] items-start left-[31.66px] top-[104.73px] w-[177.54px]">
      <Frame84 />
...
function Frame16() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] h-[288px] items-start left-[357.99px] top-[104.92px] w-[114px]">
      <Frame85 />
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
...
function Frame20() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] items-start left-[246.99px] top-[104.92px] w-[78.907px]">
      <Frame86 />
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
...
function Frame17() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] items-start left-[532.99px] top-[103.92px] w-[78.907px]">
      <Frame87 />
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
...
function Frame18() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] items-start left-[663.99px] top-[103.92px] w-[95.346px]">
      <Frame88 />
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
...
function Frame19() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] items-start left-[931px] top-[104.92px] w-[81px]">
      <Frame89 />
...
function Frame22() {
  return (
    <div className="box-border content-stretch flex gap-[8.219px] h-[17px] items-center justify-center p-[3.288px] relative rounded-[1.644px] shrink-0 w-[79px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c1e33] text-[9.863px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">Correct</p>
      </div>
    </div>
  );
}
...
function Frame23() {
  return (
    <div className="box-border content-stretch flex gap-[8.219px] h-[17px] items-center justify-center p-[3.288px] relative rounded-[1.644px] shrink-0 w-[79px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c1e33] text-[9.863px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">False</p>
      </div>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="box-border content-stretch flex gap-[8.219px] h-[18px] items-center justify-center p-[3.288px] relative rounded-[1.644px] shrink-0 w-[79px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c1e33] text-[9.863px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">Correct</p>
      </div>
    </div>
...
function Frame27() {
  return (
    <div className="box-border content-stretch flex gap-[8.219px] h-[16px] items-center justify-center p-[3.288px] relative rounded-[1.644px] shrink-0 w-[79px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c1e33] text-[9.863px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">False</p>
      </div>
    </div>
...
function Frame28() {
  return (
    <div className="box-border content-stretch flex gap-[8.219px] h-[21px] items-center justify-center p-[3.288px] relative rounded-[1.644px] shrink-0 w-[79px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c1e33] text-[9.863px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">False</p>
      </div>
    </div>
...
function Frame82() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] items-start left-[1064px] top-[104.92px] w-[81px]">
      <Frame90 />
      <Frame22 />
      <Frame23 />
      <Frame24 />
...
function SutdentTable() {
  return (
    <div className="absolute h-[392.921px] left-[calc(16.667%+77.978px)] top-[396px] w-[1200.03px]" data-name="SutdentTable">
      ...
      <Frame7 />
      <SearchBar />
      <div className="absolute bg-[#f4f6f7] h-[43px] left-[7px] top-[129px] w-[1140px]" />
      <div className="absolute bg-[#f4f6f7] h-[43px] left-[7px] top-[203px] w-[1136px]" />
      <div className="absolute bg-[#f4f6f7] h-[43px] left-[7px] top-[277px] w-[1136px]" />
      <div className="absolute bg-[#f4f6f7] h-[43px] left-[7px] top-[351px] w-[1136px]" />
      <Frame15 />
      <div className="absolute h-0 left-[7px] top-[85px] w-[1140px]">
        <div className="absolute inset-[-0.41px_-0.04%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1141 1">
            <path d="M0.410972 0.410972H1140.41" id="Line 22" stroke="var(--stroke-0, #CED8E5)" strokeLinecap="round" strokeWidth="0.821944" />
          </svg>
        </div>
      </div>
      <Frame16 />
...
function Logout1() {
  return (
    <div className="absolute box-border content-stretch flex gap-[9.863px] h-[39.453px] items-center left-[47px] overflow-clip px-[13.151px] py-[9.863px] top-[202px] w-[201.376px]" data-name="Logout">
...
function Help() {
  return (
    <div className="absolute box-border content-stretch flex gap-[9.863px] h-[39.453px] items-center left-[47px] overflow-clip px-[13.151px] py-[9.863px] top-[240px] w-[201.376px]" data-name="Help">
...
export default function ConsultantDashboard() {
  return (
    <div className="overflow-clip relative rounded-[60px] size-full" data-name="[Consultant] Dashboard">
      <Dashboard1 />
    </div>
  );
}