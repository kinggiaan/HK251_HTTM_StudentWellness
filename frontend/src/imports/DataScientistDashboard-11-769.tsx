...
function ArrowLeft2() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[17.261px]" data-name="arrow-left">
...
function Frame7() {
  return (
    <div className="absolute box-border content-stretch flex gap-[4.932px] items-center leading-[0] left-[704px] px-0 py-[4.932px] top-[35px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center not-italic relative shrink-0 text-[#2f80ed] text-[11.507px] text-center text-nowrap">
        <p className="leading-[normal] whitespace-pre">{` Export Data`}</p>
      </div>
...
function Frame8() {
  return (
    <div className="absolute box-border content-stretch flex gap-[4.932px] h-[26px] items-center left-[667px] px-0 py-[4.932px] top-[36px] w-[44px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2f80ed] text-[11.507px] text-center text-nowrap">
...
function SearchNormal() {
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
      <g id="search-normal">
        <g id="Group 1">
          <path d={svgPaths.p1e4da800} fill="var(--fill-0, #495D72)" id="Vector" />
          <path d={svgPaths.p37e2d00} fill="var(--fill-0, #495D72)" id="Vector_2" />
        </g>
        <g id="Vector_3" opacity="0"></g>
      </g>
    </svg>
  ...
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
      <g id="arrow-3">
        <g id="Vector" opacity="0"></g>
        <g id="Group 9">
          <path d={svgPaths.p3e148700} fill="var(--fill-0, #495D72)" id="Vector_2" stroke="var(--stroke-0, #495D72)" strokeWidth="0.115915" />
          <path d={svgPaths.p2d80e400} fill="var(--fill-0, #495D72)" id="Vector_3" stroke="var(--stroke-0, #495D72)" strokeWidth="0.115915" />
        </g>
      </g>
    </svg>
  );
...
function Frame15() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] items-start left-[35px] top-[110px] w-[177.54px]">
      <Frame84 />
      ...
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
        <p className="leading-[normal]">Quach Thi Trang</p>
      </div>
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
        <p className="leading-[normal]">Phung Van Hung</p>
      </div>
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
        <p className="leading-[normal]">Nguyen Van Dat</p>
      </div>
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
        <p className="leading-[normal]">Le Xuan Dai</p>
      </div>
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
        <p className="leading-[normal]">Tran Thi Tien</p>
      </div>
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
        <p className="leading-[normal]">Vo Van Vuong</p>
      </div>
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
        <p className="leading-[normal]">Nguyen Thi Thao</p>
      </div>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] h-[531px] items-start left-[385px] top-[110px] w-[114px]">
      <Frame92 />
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
...
function Frame20() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] items-start left-[271.72px] top-[110px] w-[78.907px]">
      <Frame93 />
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
...
function Frame17() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] items-start left-[553px] top-[110px] w-[78.907px]">
      <Frame94 />
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
...
function Frame18() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] items-start left-[685.98px] top-[110px] w-[95.346px]">
      <Frame95 />
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
      ...
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
        <p className="leading-[normal]">2.4</p>
      </div>
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#0c1e33] text-[11.507px] w-[min-content]">
  ...
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
      <g id="arrow-3">
        ...
        <g id="Group 9">
          <path d={svgPaths.p3e148700} fill="var(--fill-0, #495D72)" id="Vector_2" stroke="var(--stroke-0, #495D72)" strokeWidth="0.115915" />
          <path d={svgPaths.p37d0da00} fill="var(--fill-0, #495D72)" id="Vector_3" stroke="var(--stroke-0, #495D72)" strokeWidth="0.115915" />
        </g>
      </g>
    </svg>
  );
...
function Frame13() {
  return (
    <div className="bg-[#25a7fb] box-border content-stretch flex gap-[8.219px] h-[17px] items-center justify-center p-[3.288px] relative rounded-[1.644px] shrink-0 w-[79px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c1e33] text-[9.863px] text-nowrap">
...
function Frame86() {
  return (
    <div className="bg-[#ced8e5] box-border content-stretch flex gap-[8.219px] h-[17px] items-center justify-center p-[3.288px] relative rounded-[1.644px] shrink-0 w-[79px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0c1e33] text-[9.863px] text-nowrap">
...
function Frame19() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[19.727px] items-start left-[1057px] top-[111px] w-[81px]">
      <Frame96 />
      <Frame9 />
      <Frame9 />
      <Frame11 />
...
function SutdentTable() {
  return (
    <div className="absolute h-[392.921px] left-[calc(16.667%+77.978px)] top-[396px] w-[1200.03px]" data-name="SutdentTable">
      ...
      <Frame8 />
      <SearchBar />
      <div className="absolute bg-[#f4f6f7] h-[37px] left-[5px] top-[138px] w-[1143px]" />
      <div className="absolute bg-[#f4f6f7] h-[37px] left-[5px] top-[212px] w-[1143px]" />
      <div className="absolute bg-[#f4f6f7] h-[37px] left-[5px] top-[286px] w-[1143px]" />
      <div className="absolute h-[256px] left-[5px] top-[360px] w-[1143px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1143 256">
          <g id="Rectangle 16">
            <path d="M0 0H1143V36.9064H0V0Z" fill="var(--fill-0, #F4F6F7)" />
            <path d={svgPaths.p7ca8040} fill="var(--fill-0, #F4F6F7)" />
            <path d={svgPaths.p7b69d80} fill="var(--fill-0, #F4F6F7)" />
            <path d={svgPaths.p3c28d480} fill="var(--fill-0, #F4F6F7)" />
          </g>
        </svg>
      </div>
      <Frame15 />
      <div className="absolute h-0 left-[15px] top-[83px] w-[1132px]">
        <div className="absolute inset-[-0.41px_-0.04%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1133 1">
            <path d="M0.410972 0.410972H1132.41" id="Line 22" stroke="var(--stroke-0, #CED8E5)" strokeLinecap="round" strokeWidth="0.821944" />
          </svg>
        </div>
      </div>
      <Frame16 />
...
function Logout1() {
  return (
    <div className="absolute box-border content-stretch flex gap-[9.863px] h-[39.453px] items-center left-[47px] overflow-clip px-[13.151px] py-[9.863px] top-[228px] w-[201.376px]" data-name="Logout">
...
function Logout2() {
  return (
    <div className="absolute box-border content-stretch flex gap-[9.863px] h-[39.453px] items-center left-[47px] overflow-clip px-[13.151px] py-[9.863px] top-[165px] w-[201.376px]" data-name="Logout">
...
function Help() {
  return (
    <div className="absolute box-border content-stretch flex gap-[9.863px] h-[39.453px] items-center left-[47px] overflow-clip px-[13.151px] py-[9.863px] top-[266px] w-[201.376px]" data-name="Help">
...
function Sidebar() {
  return (
    <div className="absolute h-[1117.84px] left-0 top-0 w-[275.351px]" data-name="Sidebar">
      ...
      <div className="absolute bottom-[81.12%] left-0 right-0 top-[18.88%]">
...
export default function DataScientistDashboard() {
  return (
    <div className="overflow-clip relative rounded-[60px] size-full" data-name="[Data Scientist] Dashboard">
      <Dashboard1 />
    </div>
  );
}