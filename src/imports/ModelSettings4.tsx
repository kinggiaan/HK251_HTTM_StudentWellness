import svgPaths from "./svg-az683jloer";
...
function Setting2() {
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
      <g id="setting-2">
        <path d={svgPaths.pfd6b600} fill="var(--fill-0, white)" id="Vector" />
  ...
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
      <g id="logout">
        ...
        <path d={svgPaths.p3ff8d300} fill="var(--fill-0, white)" id="Vector_2" />
        <g id="Vector_3" opacity="0"></g>
      </g>
    </svg>
  );
...
export default function ModelSettings4() {
  return (
    <div className="bg-white overflow-clip relative rounded-[30px] shadow-[0px_5.94px_23.761px_0px_rgba(12,30,51,0.12)] size-full" data-name="ModelSettings 4">
      <Welcome />
      <Header />
      <WelcomeHelp />
